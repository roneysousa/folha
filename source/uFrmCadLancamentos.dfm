object frmCadLancamentos: TfrmCadLancamentos
  Left = 179
  Top = 127
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Vale Adiantamento'
  ClientHeight = 392
  ClientWidth = 591
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dbeAutotizador: TDBEdit
      Left = 16
      Top = 151
      Width = 539
      Height = 21
      CharCase = ecUpperCase
      DataField = 'MOV_AUTORIZADOR'
      DataSource = dsLancamentos
      TabOrder = 2
    end
  end
