...
begin
    ...
    Try
        ...
        frmRelFuncionarios.Caption := 'Relação de Funcionários';
...
begin
    ...
    Try
        ...
        frmRelFolhaPag.Caption := 'Relação Remuneração/Desconto'; 
        frmRelFolhaPag.ShowModal;
    Finally
        frmRelFolhaPag.Release;
        frmRelFolhaPag := nil;
...
begin
    ...
    Try
        ...
        frmRelFuncionarios.Caption := 'Relação de Caixa';
        frmRelFuncionarios.ShowModal;
    Finally
        frmRelFuncionarios.Release;
        frmRelFuncionarios := nil;
...
begin
    ...
    Try
        ...
        frmRelFolhaPag.Caption := 'Relatório Sumário de Folha';
        frmRelFolhaPag.ShowModal;
    Finally
        frmRelFolhaPag.Release;
        frmRelFolhaPag := nil;
